...
from restaurant.views import CashierCounterViewSet, CashierShiftViewSet, KitchenTicketViewSet, MenuCategoryViewSet, MenuItemViewSet, MenuModifierGroupViewSet, MenuModifierViewSet, MenuRecipeIngredientViewSet, RestaurantOrderApprovalViewSet, RestaurantOrderViewSet, RestaurantChargeConfigViewSet, RestaurantTableViewSet
...
router.register(r'charge-configs', RestaurantChargeConfigViewSet, basename='restaurant-charge-config')
