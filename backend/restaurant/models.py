...
class CashierShift(UUIDModel):
    ...
    actual_wallet = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    actual_bank_transfer = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    actual_room_posting = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    ...
    wallet_variance = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    bank_transfer_variance = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    room_posting_variance = models.DecimalField(max_digits=12, decimal_places=2, default=0)
